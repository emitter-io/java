...
import static io.emitter.mqtt.codec.MessageSupport.*;
...
public class PUBLISH extends MessageSupport.HeaderBase implements Message, Acked {
    ...
    public MQTTFrame encode() {
        try {
            ...
            // Here we have a tiny alteration of the MQTT protocol in which 
            // we can ACK publish operations as well. To that end, we need 
            // to write the message id, always.
