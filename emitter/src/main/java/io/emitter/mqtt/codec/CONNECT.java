...
import static io.emitter.mqtt.codec.MessageSupport.Message;
...
public class CONNECT implements Message {
    ...
    public MQTTFrame encode() {
        try {
            ...
            // Tell the service that we want to have message ID within PUBACK. For this, we are using reserved flag.
            flags |= 0x01;
